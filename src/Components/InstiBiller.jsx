      ...
      <div className="se">
        <div className="mi">
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p style={{ fontWeight: "bold", color: "#555555" }}>4,296,295</p>
        ...
        <div className="mi">
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p style={{ fontWeight: "bold", color: "#555555" }}>995,000</p>
        ...
        <div className="mi">
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p style={{ fontWeight: "bold", color: "#555555" }}>240,540</p>
        ...
        <div className="mi">
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p style={{ fontWeight: "bold", color: "#555555" }}>1,780</p>
        ...
        <div className="mi">
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p style={{ fontWeight: "bold", color: "#555555" }}>1,997</p>
        ...
        <div className="mi">
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <p style={{ fontWeight: "bold", color: "#555555" }}>832,970</p>
              <p style={{ color: "#FF1331" }}>-0.20%</p>
            </div>
          </div>
        </div>
