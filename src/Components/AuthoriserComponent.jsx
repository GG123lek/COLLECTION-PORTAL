...
import './AuthoriserComponent.css'; // 
...
function AuthoriserComponent({ onBack }) {
    const userTable = [
        {
  ...
  <div style={{padding:'20px',}}>
        ...
        <div>
          <p style={{fontWeight:'bold',fontSize:'25px',color:'black'}}>Authorizers</p>
        </div>
...
export default AuthoriserComponent;
